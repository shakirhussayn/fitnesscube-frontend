  ...
  head: () => ({
    meta: [
      ...
      { title: "FitnessCube — Home Gym & Fitness Equipment in Pakistan" },
      {
        name: "description",
        content:
          "Buy treadmills, ellipticals, benches, dumbbells and supplements online in Pakistan. Nationwide delivery and installation from FitnessCube.",
      },
      { name: "author", content: "FitnessCube" },
      { property: "og:title", content: "FitnessCube — Home Gym & Fitness Equipment in Pakistan" },
      {
