...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-Db09F3oA.js
var server_Db09F3oA_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-nQ4hC2qj.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DGC0Z0lz.mjs").then((n) => n.t),
		import("./start-CJmNFkbm.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_Db09F3oA_exports as t };
